...
<section class="shopping-cart">
    ...
    <div  class="box">
        ...
        <div class="price"><i class="fa fa-rupee">. </i><?php echo $fetch_cart['price']; ?>/-</div>
        ...
        <div class="sub-total"> Sub Total : <span><i class="fa fa-rupee">. </i><?php echo $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?>/-</span> </div>
    </div>
    <?php
    ...
    <div class="cart-total">
        <p>Grand Total : <span><i class="fa fa-rupee">. </i><?php echo $grand_total; ?>/-</span></p>
